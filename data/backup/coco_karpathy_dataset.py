...
class coco_karpathy_train_with_grouping(Dataset):
    def __init__(self, transform, image_root, ann_json = None, ann_root = None, batching_root = './batching', batching_config = None, device = torch.device('cpu'), ratio = 1, max_words=30, prompt=''):        
        '''
            image_root (string): Root directory of images (e.g. coco/images/)
